...
class AuthCheckFilter implements FilterInterface
{
 ...
 $urlArr = [
        // /**************Users(Menu ID : 1)****************** */
            ...
            '/admin/edit_user'    => [1,3],
            '/admin/view_user'    => [1,4],
            '/admin/delete_user'  => [1,5],

        // /**************User Group(Menu ID : 2)****************** */
            '/admin/user_group'        => [2, null],
            '/admin/add_group'         => [2,2],
            '/admin/edit_group/*'        => [2,3],
            '/admin/delete_group/*'      => [2,4],

        // /**************Member(Menu ID : 3)****************** */

            '/admin/members'            => [3, null],
            '/admin/active_members'     => [3, null],
            '/admin/inactive_members'   => [3, null],
        ...
        foreach ($urlArr as $key => $value) {
            if(url_is($key)){
                ...
                return ($crud_id !==null)  ? is_privilege($menu_id, $crud_id) : is_privilege($menu_id);
